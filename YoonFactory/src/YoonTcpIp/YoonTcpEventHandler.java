...
public class YoonTcpEventHandler {
    ...
    private static List<IShowMessageEventListener> m_pListShowMessageListener = new CopyOnWriteArrayList<IShowMessageEventListener>();
    private static List<IReceiveMessageEventListener> m_pListReceiveMessageListener = new CopyOnWriteArrayList<IReceiveMessageEventListener>();
    private static List<IRetryOpenEventListener> m_pListRetryOpenListener = new CopyOnWriteArrayList<IRetryOpenEventListener>();
